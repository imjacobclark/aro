                ...
                ContentUnavailableView(
                    ...
                    description: Text(
                        browser.isSearching
                            ...
                            : "Make sure the other Sonora library is online and sharing is enabled."
                    )
                )
            } else {
            ...
            if showingManual {
                GroupBox("Manual connection") {
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        Text(
                            "Use this only when automatic discovery cannot find the other Sonora library."
                        )
                        .font(.footnote)
                        .foregroundStyle(.secondary)
                    }
    ...
    private func connect() {
        ...
        pairingTask = Task {
            ...
            do {
                ...
                let client = SonoraSyncClient(pairingBaseURL: url)
                ...
                for _ in 0 ..< 150 {
                    ...
                    case .approved(let completed):
                        let secureClient = SonoraSyncClient(
                            baseURL: url,
                    ...
                    case .rejected:
                        ...
                        return
                    case .expired:
                        status = "The connection code expired. Generate a new code from the Sonora library."
                        return
                    }
                }
