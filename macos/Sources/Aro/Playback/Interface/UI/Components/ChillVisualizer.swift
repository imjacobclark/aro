                ...
                context.drawLayer { layer in
                    ...
                    layer.fill(
                        ...
                        with: .linearGradient(
                            Gradient(
                                colors: [
                                    AroTheme.violet.opacity(0.58),
                                    AroTheme.coral.opacity(0.52),
                                    AroTheme.amber.opacity(0.55)
                                ]
                            ),
                            startPoint: CGPoint(
                                x: side * 0.16,
                    ...
                    layer.stroke(
                        waveform,
                        with: .color(
                            AroTheme.coral.opacity(isActive ? 0.88 : 0.3)
                        ),
                        lineWidth: 1.1
                    )
                }
                ...
                Rectangle()
                    .stroke(
                        LinearGradient(
                            colors: [
                                .white.opacity(0.18),
                                AroTheme.coral.opacity(0.14),
                                AroTheme.violet.opacity(0.2)
                            ],
